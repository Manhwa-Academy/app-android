...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th2 03, 2026 lúc 12:56 AM
...
--
-- Cấu trúc bảng cho bảng `ec_categories`
--
...
--
-- Đang đổ dữ liệu cho bảng `ec_categories`
--
...
--
-- Cấu trúc bảng cho bảng `ec_configuration`
--
...
--
-- Đang đổ dữ liệu cho bảng `ec_configuration`
--
...
--
-- Cấu trúc bảng cho bảng `ec_orderscontent`
--
...
--
-- Cấu trúc bảng cho bảng `ec_productsphoto`
--
...
--
-- Đang đổ dữ liệu cho bảng `ec_productsphoto`
--
...
--
-- Cấu trúc bảng cho bảng `ec_productsreview`
--
...
--
-- Cấu trúc bảng cho bảng `ec_product_category`
--
...
--
-- Đang đổ dữ liệu cho bảng `ec_product_category`
--
...
--
-- Cấu trúc bảng cho bảng `ec_users`
--
...
--
-- Đang đổ dữ liệu cho bảng `ec_users`
--

INSERT INTO `ec_users` (`id`, `email`, `password`, `first_name`, `last_name`, `phone`, `address`, `role`, `active`, `create_at`, `update_at`) VALUES
(1, 'phongkaster@gmail.com', '$2y$10$DbMcjgmEvTO/OMcYl.HhuOKyhPkA8F4YcTQbpBJderkog.Izn0YjW', 'phongh', 'kaster', NULL, NULL, 'admin', 1, '2022-06-29 20:54:20', '2026-02-02 18:42:34'),
(7, 'n18dccn147@student.ptithcm.edu.vn', '$2y$10$/mCY8QdXm3Huk1lidiorg.OmbiIwb0FfYIjdSUEUAifv7DhynATPy', 'JON', 'SNOW', NULL, NULL, 'member', 0, '2022-07-03 08:24:08', '2022-07-03 08:24:08'),
(8, 'n18dccn148@student.ptithcm.edu.vn', '$2y$10$d4Ic6vmJ8zBvZNNLZmY.1u9iTyO1Ux52TRlwvUO8s8SEr/e/IA4XC', 'phong', 'nguyen', NULL, NULL, 'member', 0, '2022-07-02 12:27:08', '2022-07-02 12:27:08'),
(9, 'vuliztva1@gmail.com', '$2y$10$Rd1/epFXovY/eYWA72V/c.96PR.5uKC.wQHCQSIoMaENHYNd.VUbe', 'abcd', 'magic', NULL, NULL, 'member', 1, '2026-02-02 17:21:33', '2026-02-02 17:21:33'),
(10, 'takina412eee@gmail.com', '$2y$10$tjfv63NdTxzXzTS5Voz2oOpjcvvkUflfLos4TVRg6FuOs2s1ObO12', 'hhhuh', 'uio', NULL, NULL, 'member', 1, '2026-02-02 17:29:34', '2026-02-02 17:29:34'),
(11, 'yuukahayase661@gmail.com', '$2y$10$AFt/ul9LuxqRuYlMPr4.DeEJO6VFr1JyOoLo/jKwHVirnoR0D2g5.', 'bbbbb', 'juhh', NULL, NULL, 'member', 1, '2026-02-02 18:30:57', '2026-02-02 18:30:57');
...
--
-- Chỉ mục cho bảng `ec_categories`
--
ALTER TABLE `ec_categories`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `ec_configuration`
--
...
--
-- Chỉ mục cho bảng `ec_orderscontent`
--
...
--
-- Chỉ mục cho bảng `ec_productsphoto`
--
...
--
-- Chỉ mục cho bảng `ec_productsreview`
--
...
--
-- Chỉ mục cho bảng `ec_product_category`
--
...
--
-- AUTO_INCREMENT cho bảng `ec_categories`
--
ALTER TABLE `ec_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `ec_configuration`
--
ALTER TABLE `ec_configuration`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `ec_orderscontent`
--
ALTER TABLE `ec_orderscontent`
...
--
-- AUTO_INCREMENT cho bảng `ec_productsphoto`
--
ALTER TABLE `ec_productsphoto`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT cho bảng `ec_productsreview`
--
ALTER TABLE `ec_productsreview`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `ec_product_category`
--
ALTER TABLE `ec_product_category`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `ec_users`
--
ALTER TABLE `ec_users`
